<template>
    <div>
    <a-card title="丢单" :headStyle="{ 'height': '66px' }">
        <template #extra>
    ...
    <ApproveDetail :open="isModalVisible" :record="selectedRecord" @close="handleClose" @ok="handleOk"
        :isModalVisible="isModalVisible" :isWaitingSign="isWaitingSign" :isSignApprovalStatus="isSignApprovalStatus" :isLoss="isLoss">
    </ApproveDetail>
    </div>
</template>  
